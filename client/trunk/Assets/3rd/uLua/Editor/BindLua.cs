...
public static class LuaBinding
{
    ...
    static void GenLuaBinder()
    {
        ...
        string[] files = Directory.GetFiles("Assets/3rd/uLua/Source/LuaWrap/", "*.cs", SearchOption.TopDirectoryOnly);
        ...
        if (AppConst.AutoWrapMode) {
			string wrapfile =  Util.LuaPath("System/Wrap.lua");
