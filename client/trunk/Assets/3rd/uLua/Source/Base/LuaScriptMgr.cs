...
public class LuaScriptMgr
{
	...
	public delegate void BeforeEnterLuaCallbackType ();

	public BeforeEnterLuaCallbackType beforeEnterLuaCallback;
...
//#endif
		if (beforeEnterLuaCallback != null) {
			beforeEnterLuaCallback();		
		}
