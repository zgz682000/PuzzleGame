...
public class DelegateFactoryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("UnityEngine_UI_InputField_OnValidateInput", UnityEngine_UI_InputField_OnValidateInput),
	...
	static int UnityEngine_UI_InputField_OnValidateInput(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		LuaFunction arg0 = LuaScriptMgr.GetLuaFunction(L, 1);
		Delegate o = DelegateFactory.UnityEngine_UI_InputField_OnValidateInput(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
